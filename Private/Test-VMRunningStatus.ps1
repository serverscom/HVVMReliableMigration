function Test-VMRunningStatus {
    ...
    try {
        ...
        Write-Debug -Message 'if ($VMItem.State -eq [Microsoft.HyperV.PowerShell.VMState]::Running)'
        if ($VMItem.State -eq [Microsoft.HyperV.PowerShell.VMState]::Running) {
