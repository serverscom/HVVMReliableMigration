function Test-VMSavedStatus {
    ...
    try {
        ...
        Write-Debug -Message 'if ($VMItem.State -eq [Microsoft.HyperV.PowerShell.VMState]::Saved)'
        if ($VMItem.State -eq [Microsoft.HyperV.PowerShell.VMState]::Saved) {
